...
/* Form Title Images */
import Amazon from '../../../assets/images/dashboard/form-title-pics/amazon.svg';

const Amazonproductdescription = (props) => {

  /* Placeholder For Amazon Textarea */
  const keybenifits_placeholder = "[Product details]\n[Fun facts]\n[Any instructions]";

  return (
    <div>
        <div className='bg-white db-heading-1 px-4 py-3 db-header bb-1px-link-water'>
            <img src={Amazon} alt="" className='me-2' />
            Amazon Product Description
        </div>
        <div className='bg-white db-heading-2 px-4 py-3 bb-1px-link-water'>
            Create Amazon descriptions that will make your readers salivate.
        </div>
