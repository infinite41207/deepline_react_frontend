...
/* Form Title Images */
import Facebook from '../../../assets/images/dashboard/form-title-pics/facebook.svg';

const Facebookad = (props) => {

  /* Placeholder For Facebook Textarea */
  ...
  return (
      <div>
          ...
          <div className='bg-white db-heading-2 px-4 py-3 bb-1px-link-water'>
            Produce Facebook advertising tailored to your audience.
          </div>
