...
/* Form Title Images */
import Blog from '../../../assets/images/dashboard/form-title-pics/blog.svg';

const Blogpost = (props) => {

  /* Placeholder For blog Textarea */
  const keybenifits_placeholder = "[Blog details]\n[Fun facts]\n[Any instructions]";

  return (
    <div>
        <div className='bg-white db-heading-1 px-4 py-3 db-header bb-1px-link-water'>
            <img src={Blog} alt="" className='me-2' />
            Blog Posts
        </div>
