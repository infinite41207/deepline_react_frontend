...
/* Form Title Images */
import Emailicon from '../../../assets/images/dashboard/form-title-pics/email.svg';

const Email = (props) => {

  /* Placeholder For Email Textarea */
  const keybenifits_placeholder = "[Email details]\n[Fun facts]\n[Any instructions]";
  ...
  return (
    <div>
        ...
        Upgrade your correspondence by creating professional emails.
        </div>
