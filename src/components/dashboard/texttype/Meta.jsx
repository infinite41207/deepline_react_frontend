...
/* Form Title Images */
import Metaicon from '../../../assets/images/dashboard/form-title-pics/meta.svg';

const Meta = (props) => {

  /* Placeholder For Meta Textarea */
  const keybenifits_placeholder = "[Meta details]\n[Facts]\n[Any instructions]";

  return (
    <div>
        <div className='bg-white db-heading-1 px-4 py-3 db-header bb-1px-link-water'>
            <img src={Metaicon} alt="" className='me-2' />
            Meta Descriptions
        </div>
        <div className='bg-white db-heading-2 px-4 py-3 bb-1px-link-water'>
            Generate brief, SEO-optimized meta descriptions for your website.
        </div>
