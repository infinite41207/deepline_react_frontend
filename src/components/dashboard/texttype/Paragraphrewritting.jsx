...
/* Form Title Images */
import Paragraph from '../../../assets/images/dashboard/form-title-pics/paragraph.svg';

const Paragraphrewritting = (props) => {

  /* Placeholder For Paragraph Textarea */
  const keybenifits_placeholder = "[Paste paragraph]\n[Any instructions]";

  return (
    <div>
        <div className='bg-white db-heading-1 px-4 py-3 db-header bb-1px-link-water'>
            <img src={Paragraph} alt="" className='me-2' />
...
export default Paragraphrewritting